...
export const MOCK_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answerEn:
      "Lankan Ads offers three tiers: Standard (Rs. 699 for 7 days in normal feed), Premium (Rs. 1,399 with 24 hours in the premium spotlight then 6 days as standard), and Platinum (Rs. 8,000 with 3 days in the top spotlight then 4 days as standard).",
    displayOrder: 2,
  },
  {
    id: "faq-3",
